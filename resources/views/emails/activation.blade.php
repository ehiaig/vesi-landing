	...
	<div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
		...
		<div style="padding: 60px 70px; border-top: 1px solid rgba(0,0,0,0.05);">
			...
			<div style="color: #636363; font-size: 14px;">
				<p>
					Thanks for signing up for an account with Vesicash. To use your account, you’ll need to confirm your email via the button below. Once you click the button, just login to your account and you are set to go. Ok?
				</p>
			</div>
			<a href="{{url('user/verify', $user->verifyUser->token)}}" style="padding: 8px 20px; background-color: #4B72FA; color: #fff; font-weight: bolder; font-size: 16px; display: inline-block; margin: 20px 0px; margin-right: 20px; text-decoration: none;">Activate my account</a>
		</div>
